...
function App() {
  ...
  let btns: any = [7,8,9,"DEL",4,5,6,"+",1,2,3,"-",".",0,"/","*","=","RESET"]
  ...
  <div className="root" id={colorss+'root'}> 
    <div className="App" id={colorss + "App"}>
        <nav className='nav-bar' id={colorss+"nav-bar"}>
          <div className="title" id={colorss+'title'}>calc</div>
          <div className="right-nav" id={colorss+'right-nav'}>
            <div className="theme" id={colorss+'theme'}>THEME</div>
        ...
        <div className="display" id={colorss+'display'}>{count}</div>
